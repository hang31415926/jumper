...
Game.prototype = {
  ...
  _createJumper: function() {
    ...
    // var texture = THREE.ImageUtils.loadTexture("./static_standr.png");
    // var material = new THREE.MeshBasicMaterial({
    //   map:texture,
     ...
     * 纹理贴图网格模型
     */
    var plane = new THREE.PlaneGeometry(this.config.jumperWidth, this.config.jumperHeight);//矩形平面
    var texture = THREE.ImageUtils.loadTexture("./static_standr.png");
    ...
    // // var texture = THREE.ImageUtils.loadTexture("./static_standr.png",null,function(t){});
